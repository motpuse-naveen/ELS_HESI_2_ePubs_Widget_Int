    ...
    question_groups: {
        ...
        group5: {
            ...
            items: [
                {
                  headerImage:{},
                  dropdownHtml:`<p><strong>Question #5 (Drop-Down Table):</strong> Complete the following table by choosing the medication classification for each medication ordered for the client to be included in the client’s teaching.</p>
