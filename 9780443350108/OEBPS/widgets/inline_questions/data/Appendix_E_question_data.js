...
const questions_data = {
    sharedProperties: {
      ...
      pageStateIdentifier:"Id1750085160613",//statedata identifier to store data in localstorage.
    ...
    question_groups: {
          ...
          items: [
              {
                ...
                <p>The PN validates that teaching is effective when the client states: Cigarette smoking causes peripheral #dropdown1# which leads to increased peripheral vascular resistance and #dropdown2# peripheral tissue and organ perfusion.</p>`,
                dropdowns:{
        ...
        group5: {
            ...
            items: [
                {
                  headerImage:{},
                  dropdownHtml:`<h2 class="quesNum">Question 5</h2><p>Complete the following table by choosing the medication classification for each medication ordered for the client to be included in the client’s teaching.</p>
