...
const questions_data = {
    sharedProperties: {
      ...
      pageStateIdentifier:"Id1749848396525",//statedata identifier to store data in localstorage.
    ...
    question_groups: {
        group1: {
            ...
            items: [
              {
                headerImage:{},
                clozeHtml:`<p>A pediatric client is prescribed digoxin for a congenital heart defect. The maintenance dosage ordered is 5 mcg/kg/day. The child weighs 10 kg. The prescription requires the digoxin to be administered twice daily. The PN prepares #cloze1# mcg of digoxin at each dose.</p>`,
                clozes:{
                  cloze1:{correctValue: "25 mcg/dose", clozelabel:"fill in the blank"},
                },
