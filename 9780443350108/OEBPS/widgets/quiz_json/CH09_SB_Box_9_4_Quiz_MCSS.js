var quiz = [
	{
        ...
        answer: 3,
         state: `notAnswered`,
        ansText:`<strong>Rationale:</strong> The PN should not culture the child’s throat to avoid airway compromise in epiglottitis. It is safe to culture the child’s throat in tonsillectomy, streptococcal infection, and bronchiolitis.`,
        userAnswered: [],
        type:`MCSS`
    } ,

    {
        ...
        answer: 1,
         state: `notAnswered`,
        ansText:`<strong>Rationale:</strong> Restlessness is an early symptom of respiratory distress that should be reported to the RN. Fatigue, barking cough, and crying are symptoms of croup that should also be reported to the RN but do not require immediate intervention.`,
        userAnswered: [],
        type:`MCSS`
    } 
