var quiz = [
    {
        q: `Which action by the unlicensed assistive personnel (UAP) requires immediate follow-up by the PN?`,
        q2: ``,
        q3: [],
        ...
        answer: 2,
        ansText:`<strong>Rationale:</strong>  Sunlight may trigger lupus and should be avoided. The PN needs to instruct both the client and the UAP. The other clients do not require immediate follow-up.`, 
        state: `notAnswered`,
        userAnswered: [],
        type:`MCSS`
    } 
