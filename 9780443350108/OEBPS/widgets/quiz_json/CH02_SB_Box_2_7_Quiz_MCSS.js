var quiz = [
{
        q: `Which assignment should the PN delegate to a UAP in an acute care setting?`,
        q2: ``,
        q3: [],
	...
	{
        q: `Which situation warrants a variance (incident) report by the PN?`,
        q2: ``,
        q3: [],
		...
		not require documentation via an incident report but should be documented in the chart. Although an allergic reaction is a concerning incident,
	    this type of reporting is not appropriate. The HCP should be notified of the allergic reaction and the allergy should be noted on the client’s chart.`,
        state: `notAnswered`,
        userAnswered: [],
        type:`MCSS`
    } 
