var quiz = [
{
        q: `The PN is preparing for change of shift. Which action by the PN is characteristic of ineffective handoff communication?`,
        q2: ``,
        q3: [],
        ...
        answer: 2,
        ansText:`<strong>Rationale:</strong> The PN should not discuss or gossip about a problem with a fellow coworker during shift handoff. This incident should be
		...
		Using the electronic medical record (EMR) ensures accurate reporting during handoff communication and is recommended to provide accurate medication 
		administration history information. Reducing the likelihood of interruptions during handoff is an effective communication technique.`, 
        state: `notAnswered`,
        userAnswered: [],
        type:`MCSS`
    } 
