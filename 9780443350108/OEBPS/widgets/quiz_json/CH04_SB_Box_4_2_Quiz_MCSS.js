var quiz = [
	{
       q: `A client recovering from ARDS is awake and alert but has residual fatigue and generalized weakness. His current vital signs are HR 83
	   beats/min, BP 104/64 mm Hg, respiratory rate 27 breaths/min; SpO2 is 92% on 2 L/min oxygen via nasal cannula. Which vital sign finding would 
	...
	{
       q: `A client is admitted with a 2-day history of cough, fever, and fatigue. The medical history is positive for type I diabetes and recent 
	   upper respiratory infection. Vital signs are HR 109 beats/min, BP 102/58 mm Hg, respiratory rate 24 breaths/min, temperature 104 °F (40°C), 
	...
	{
        q: `A client with a history of uterine fibroids had a cesarean delivery 12 hours earlier and delivered healthy twin girls. At shift change,
		the PN assesses the client and notes shortness of breath, cool extremities, and oozing of blood from the incision site. Based on the client’s
