var quiz = [
	...
	
	{
		...
		serosanguineous drainage and the intestines protruding slightly from the incision. The PN would immediately implement which priority intervention(s)? (Select all that apply.)`,
        q2: ``,
        q3: [],
	...
	{
        q: `The PN checks a client’s abdominal surgical incision for signs of infection. Which sign(s) or symptom(s) would indicate an infection? (Select all that apply.)`,
        q2: ``,
        q3: [],
