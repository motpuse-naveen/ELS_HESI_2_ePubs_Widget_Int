var quiz = [
    ...
    
    {
        ...
        q2: ``,
        q3: [],
        option: [`He mixes glargine and lispro in the same syringe for the morning doses.`,`He leaves the insulin syringe in place for 10 seconds after injection.`,
...

    {
...

     {
        ...
        q2: ``,
        q3: [],
        option: [`A preschooler with a barking cough, an O2saturation of 93% on room air, and occasional inspiratory stridor.`,
        ...
        optionFeedback: [`This is not a medical emergency. With an O2 saturation of 93%, the child is not in acute respiratory distress.`,
...

     {
        ...
        q2: ``,
        q3: [],
        option: [`A woman at 30 weeks’ gestation who has been diagnosed with mild preeclampsia and was unable to relieve her heartburn. `,
        ...
        optionFeedback: [`A sign of a potential complication of eclampsia is epigastric pain, which may be indicative of liver damage and HELLP (hemolysis, elevated liver enzymes, low platelet count) syndrome, a medical emergency.`,
...

     {
        ...
        optionFeedback: [`Normal fluctuation of the water, called tidaling, reflects the intrapleural pressure during inspiration and expiration. If no tidaling is
...
`, 
...

     {
        ...
        optionFeedback: [`Letting the physician know the needs of the client is important, but key information may be missed using this way to communicate.`,
...

     {
        ...
        optionFeedback: [`This client would be triaged black.`,
...

     {
        ...
        q2: ``,
        q3: [],
        option: [`  The young mother diagnosed with schizophrenia who is hearing voices say that they are pursuing her children.`,
        ...
        optionFeedback: [`This client is at risk of hurting herself or her children. She needs to be seen first.`,
