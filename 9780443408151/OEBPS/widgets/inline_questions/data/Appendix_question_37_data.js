...
const questions_data = {
  sharedProperties: {
    ...
    pageStateIdentifier: "Id13247501024623001299", //statedata identifier to store data in localstorage.
  ...
  question_groups: {
    group1: {
      ...
      groupHeadHtml: `The arrhythmia alarm sounds on a client on the telemetry unit, indicating that the client is in ventricular tachycardia. Place the RN’s actions for this client in order of priority from first to last.`,
      ...
      items: [
        ...
        {
          headerImage: {},
          dropdownHtml: `<span>Assess for a pulse and blood pressure. #dropdown1#</span>`,
          dropdowns: {
            dropdown1: {
              values: [],
              correctValue: "1",
