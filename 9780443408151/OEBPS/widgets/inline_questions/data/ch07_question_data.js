...
const questions_data = {
    sharedProperties: {
      ...
      pageStateIdentifier:"Id1750102436621",//statedata identifier to store data in localstorage.
            ...
            items: [
                {
                  ...
                  correctFeedback: `<p>Your answer is correct.</p><p><strong>Rationale:</strong> The scenario indicates that this client may be experiencing a kidney stone. Computed tomography (CT) of abdomen is the most accurate radiological procedure to diagnose renal calculi. A midstream U/A can also be effective for diagnosing urinary complications. Ketorolac can help with pain and relax the ureter to facilitate stone passage. The other orders are not indicated for this client at this time.</p>`,
