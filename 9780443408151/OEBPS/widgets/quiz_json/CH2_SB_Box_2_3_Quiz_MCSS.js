var quiz = [
{
        q: `A family member of a client who is in a restraint asks why it was applied. Which response would the RN make?`,
        q2: ``,
        q3: [],
        option: [`The restraint was ordered by the HCP.`, `There is not enough staff to keep the client safe all the time.`, `The other clients are upset when the client wanders at night.`, `The client’s actions place the client at high risk for self-harm.`],
        //optionFeedback: [``],],
