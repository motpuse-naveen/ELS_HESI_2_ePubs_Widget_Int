var quiz = [
{
        q: `Which assignment should the RN delegate to a UAP in an acute-care setting?`,
        q2: ``,
        q3: [],
        option: [`Checking blood glucose hourly for a client with a continuous insulin drip.`, `Giving PO medications left at the bedside for the client to take after eating.`, `Taking vital signs for an older client with left humeral and left tibial fractures.`, `Replacing a client’s pressure ulcer dressing that has been soiled by incontinence.`],
        optionFeedback: [``],
    ...
    {
        q: `Which situation warrants a variance (incident) report by the RN?`,
        q2: ``,
        q3: [],
        option: [`A client refuses to take prescribed medication.`, `A client’s status improves before completion of the course of medication.`, `A client has an allergic reaction to a prescribed medication.`, `A client received medication prescribed for another client.`],
        optionFeedback: [``],
        optionStyleType: `st-decimal`,
        answer: 3,
