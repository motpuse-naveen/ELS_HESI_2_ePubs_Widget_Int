var quiz = [
  {
    q: `The RN is administering 0900 medications to three clients on a telemetry unit when the UAP reports that another client is complaining of a sudden onset of substernal discomfort. Which action would the RN take?`,
    q2: ``,
    q3: [],
    option: [
      `Ask the UAP to obtain the client’s vital signs`,
      `Assess the client’s discomfort`,
      `Advise the client to rest in bed`,
      `Observe the client’s ECG pattern`,
    ],
    //optionFeedback: [``],],
  ...
  },
  {
    ...
    optionStyleType: `st-decimal`,
    answer: [1],
    ansText: `<strong>Rationale: </strong><strong>Correct order: 3, 5, 2, 1, 4. </strong> For emergency care of the client with chest pain, it is important to quickly gather vital signs, provide O2, administer nitroglycerin, notify the rapid response team, and finally, document.`,
    state: `notAnswered`,
    userAnswered: [],
    type: `MCSS`,
  },
  ...
  {
    q: `The RN is caring for a client when the client suddenly becomes unconscious. The RN identifies the following rhythm on the monitor. Which action is the highest priority?`,
    q2: ``,
    q3: [],
    option: [
