var quiz = [
{
        q: `An older client with a history of hypertension, heart failure, and sleep apnea is admitted to the acute care unit. Which finding would relate most directly to a diagnosis of acute decompensated heart failure (ADHF)? (Select all that apply.)`,
        q2: ``,
        q3: [],
