var quiz = [
 {
        ...
        q2: ``,
        q3: [],
        option: [`Ask whether there are family, friends, or clergy to call.`, `Inform the significant other about the treatment the victim received.`, `Provide education about the stages of grief and loss.`, `Assess the significant other’s level of anxiety.`],
    ...
    },
    {
        ...
        q2: ``,
        q3: [],
        option: [`Women should be assessed only if they are part of a high-risk group.`, `Women may be assessed in the presence of young children but not intimate partners.`, `The assessment only needs to be completed at the beginning of the pregnancy.`, `Women should be reassessed face to face by an RN as the pregnancy progresses.`],
    ...
    },
     {
        ...
        q2: ``,
        q3: [],
        option: [`Ask one more staff member to ride in the elevator.`, `Offer a prescribed anti-anxiety medication.`, `Begin desensitization about riding the elevator.`, `Affirm the client’s fears about riding the elevator.`],
    ...
    },
    {
        ...
        q2: ``,
        q3: [],
        option: [`Give the client a sedative or hypnotic.`, `Administer an antipsychotic.`, `Assign a UAP to sit with the client.`, `Process with both clients about event.`],
    ...
    },
    {
        ...
        q2: ``,
        q3: [],
        option: [`Assign the same RN to care for the client.`, `Avoid challenging inappropriate behavior.`, `Limit the client’s contact with other clients.`, `Remove consequences for acting-out behaviors.`],
    ...
    },
     {
        ...
        q2: ``,
        q3: [],
        option: [`Teach the client the importance of self-expression.`, `Supervise the client’s activities closely.`, `Include the client in daily group therapy.`, `Facilitate social interactions with others.`],
    ...
    },
    {
        ...
        q2: ``,
        q3: [],
        option: [`A basketball game in the gym.`, `Jogging at least 1 mile.`, `A table tennis game with a peer.`, `Group activity with the art therapist.`],
