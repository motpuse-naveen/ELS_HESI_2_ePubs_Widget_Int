var quiz = [
{
	...
	{
        q: `The RN is caring for a client who is 24 hours postprocedure for a hemicolectomy with a temporary colostomy placement. The RN assesses the client’s stoma, which is dry and dark red. Which action should the RN take based on this finding?`,
        q2: ``,
        q3: [],
        option: [`Notify the HCP of the finding.`, `Document the finding in the client record.`, `Replace the pouch system over the stoma.`, `Place petrolatum gauze dressing on the stoma.`],
        //optionFeedback: [``],],
        optionStyleType: `st-decimal`,
        answer: [0],
    ...
    {
        q: `After the change of shift report, the RN reviews assignments. Which client would the RN assess first?`,
        q2: ``,
        q3: [],
        option: [`The elderly client receiving palliative care for heart failure who complains of constipation and nervousness.`, `The adult client who is 48 hours postoperative for a colectomy and who is reported to be having nausea and vomiting.`, `The middle-aged client with chronic renal failure whose urinary catheter has been draining 95 mL for 8 hours.`, `The client who is 2 days postoperative for a thoracotomy and who has chest tubes, is on oxygen at 3 L/min, and has a respiratory rate of 12 breaths/min.`],
        //optionFeedback: [``],],
        optionStyleType: `st-decimal`,
        answer: [1],
