var quiz = [
{
        q: `The charge nurse confronts a staff nurse whose behavior has been resentful and negative since a change in unit policy was announced. The staff nurse states, “Don’t blame me; nobody likes this idea.” Which is the charge nurse’s priority action?`,
        q2: ``,
        q3: [],
        option: [`Confront the other staff members involved in the change of unit policy.`, `Call a unit meeting to review the reasons the change was made.`, `Develop a written unit policy for the expression of complaints.`, `Encourage the nurse to be accountable for their own behavior.`],
        //optionFeedback: [``],],
