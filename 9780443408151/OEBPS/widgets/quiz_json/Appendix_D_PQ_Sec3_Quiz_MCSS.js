var quiz = [
{
        ...
        q2: ``,
        q3: [],
        option: [`Assist a client to ambulate who was just admitted with stroke symptoms.`, `Encourage additional oral fluids for an elderly client with pneumonia who has developed a fever.`, `Report the ability of a client with myasthenia gravis to manage the supper tray independently.`, `Record the number of liquid stools of a client who received lactulose for an elevated NH3 level.`],
    ...
    },
   {
        ...
        q2: ``,
        q3: [],
        option: [`Active tuberculosis who is leaving the room without a mask.`, `End-stage renal disease requesting orange juice to drink.`, `Anemia who is complaining of fatigue and asking for help getting dressed to go home.`, `Chronic obstructive pulmonary disorder who removes his oxygen and is leaving the unit to smoke.`],
    ...
    },
    {
        ...
        q2: ``,
        q3: [],
        option: [`Call in an extra RN or UAP for the next shift.`, `Assign one of the current UAPs to sit with the client.`, `Move the client to another room with a roommate.`, `Administer an as-needed (PRN) dose of lorazepam.`],
    ...
    },
    {
        ...
        q2: ``,
        q3: [],
        option: [`Check fundal firmness and lochia for the clients who delivered vaginally.`, `Take vital signs every 15 minutes for a client with preeclampsia.`, `Provide breastfeeding instructions for a primigravida.`, `Assist with daily care activities for all clients as needed.`],
