var quiz = [
{
        q: `The RN is caring for several clients. Which client would the RN assess first?`,
        q2: ``,
        q3: [],
        option: [`A 20-year-old client whose Glasgow coma scale is 8 and unchanged from the last assessment`, `A 45-year-old client with a left-sided cerebrovascular accident (CVA) who refuses his morning care`, `A 38-year-old client who is increasingly stuporous after undergoing an aneurysm repair`, `A 29-year-old client post–motor vehicle accident (MVA) whose Glasgow coma scale was 9 one hour ago and is now 10`],
        //optionFeedback: [``],],
