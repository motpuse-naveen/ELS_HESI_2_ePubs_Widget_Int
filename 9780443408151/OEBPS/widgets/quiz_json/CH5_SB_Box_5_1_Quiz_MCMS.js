var quiz = [
{
	...
	
	{
        ...
        optionStyleType: `st-decimal`,
        answer: [3],
        ansText:`<strong>Rationale:</strong> Small amounts of subcutaneous emphysema (crackling sensation) after thoracic surgery are common and will be absorbed, causing no problem. The RN should continue to monitor the insertion site for worsening that includes swelling of the neck and chest. Other actions are not indicated at this time.`, 
        state: `notAnswered`,
        userAnswered: [],
        type:`MCSS`
    } 
